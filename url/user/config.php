...
define( 'YOURLS_DB_USER', $url["user"] );

/** MySQL database password */
define( 'YOURLS_DB_PASS', $url["pass"] );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', substr($url["path"], 1) );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', eg. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', $url["host"] );
...
define( 'YOURLS_SITE', 'http://bpilon.tk/url' );
...
define( 'YOURLS_COOKIEKEY', 'yZCq7Pc@7EOn-qjqK9Itjh$|6F_Ep)tMWGxfr}nJ' );
